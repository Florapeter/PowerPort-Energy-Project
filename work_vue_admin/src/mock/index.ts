...
//echarts图表数据接口4 表格
Mock.mock("https://www.demo.com/chartData4",'get',()=>{
  return {
    code: 200,
    message: '操作成功',
    data: {
      list:[
        { id:1,cityName:'广州',revenue:'52,457',percentage:'24' },  // 数据值和名称
        { id:2,cityName:'上海',revenue:'324,234',percentage:'24' },  // 数据值和名称
        { id:3,cityName:'佛山',revenue:'192,255',percentage:'24' },  // 数据值和名称
        { id:4,cityName:'珠海',revenue:'17,540',percentage:'24' },  // 数据值和名称
        { id:5,cityName:'深圳',revenue:'662,337',percentage:'24' },  // 数据值和名称
        { id:6,cityName:'厦门',revenue:'22,941',percentage:'24' },  // 数据值和名称
        { id:7,cityName:'长沙',revenue:'565,221',percentage:'24' },  // 数据值和名称
      ]
    }
  };
})
