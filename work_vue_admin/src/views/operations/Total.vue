                    ...
                    <el-form-item :label="'时间区间'+(index+1)+':'" v-for="(timeSlot,index) in ruleForm.date" :key="index">
                        <el-col :span="8">
                            <el-form-item label="开始时间" :prop="'date.'+index+'.date1'" :rules="{required:true,message:'时间不能为空',trigger:'blur'}">
                                <el-time-picker value-format="hh:mm:ss" v-model="timeSlot.date1" placeholder="选择开始时间" style="width: 100%" :disabled="!title"/>
                            </el-form-item>
                        </el-col>
                        <el-col :span="1">
                            <span class="ml"></span>
                        ...
                        <el-col :span="8">
                            <el-form-item label="结束时间" :prop="'date.'+index+'.date2'" :rules="{required:true,message:'时间不能为空',trigger:'blur'}">
                                <el-time-picker value-format="hh:mm:ss" v-model="timeSlot.date2" placeholder="选择结束时间" style="width: 100%" :disabled="!title"/>
                            </el-form-item>
                        </el-col>
                        <el-col :span="7">
                            <el-form-item label="电费" :prop="'date.'+index+'.electricity'" :rules="{required:true,message:'电费不能为空',trigger:'blur'}">
                                <el-input placeholder="请输入电费" style="width: 100%" v-model="timeSlot.electricity" :disabled="!title"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-form-item>
