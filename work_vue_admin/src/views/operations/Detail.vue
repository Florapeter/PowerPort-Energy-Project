<template>
    <el-card>
        <el-descriptions :title="`订单编号：${rowDate.orderNo}`">
            <el-descriptions-item label="订单编号">{{rowDate.orderNo}}</el-descriptions-item>
            <el-descriptions-item label="设备编号">{{rowDate.equipmentNo}}</el-descriptions-item>
            <el-descriptions-item label="订单日期">{{rowDate.date}}</el-descriptions-item>
            ...
            <el-descriptions-item label="结束时间">{{rowDate.endTime}}</el-descriptions-item>
            <el-descriptions-item label="订单金额(元)">{{rowDate.money}}</el-descriptions-item>
