    ...
    <el-row :gutter="20">
        <el-col :span="18">
            <el-card>
                <div class="title">
                    <h3>今日设备运行状态</h3>
                    <p class="ml">更新时间：2025年4月20日</p>
                    <el-icon color="#86909c" style="margin-left: 5px"><Refresh /></el-icon>
                </div>
                <div class="equipment">
                    <div class="item">
        ...
        <el-col :span="6">
            ...
            <!-- <el-card class="mt">
                ...
                <ul class="ranking-list" v-for="items in chartData4" :key="items.id">
                    <li class="ranking-item">
                        <span
                            ...
                            >{{ items.id }}</span
                        >
                        <span class="store-name">{{ items.cityName }}</span>
                        <span class="sales">{{ items.revenue }}</span>
            ...
            <el-card class="mt">
                ...
                <ul class="ranking-list">
                    ...
                    <li class="ranking-item">
                        <span class="rank" style="background-color: hotpink; color: #fff">2</span>
                    ...
                    <li class="ranking-item">
                        <span class="rank" style="background-color: purple; color: #fff">3</span>
